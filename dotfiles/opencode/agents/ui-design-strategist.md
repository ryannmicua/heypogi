...
See also the supporting reference at `../../agents_data/ui-design-strategist/references/success_and_scope.md` for the success rubric, scope boundaries, referral matrix, and pushback examples.

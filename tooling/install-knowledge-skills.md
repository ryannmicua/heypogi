...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File tooling/scripts/install-knowledge-skills.ps1
```
...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File tooling/scripts/install-knowledge-skills.ps1 -CreateDest
```
...
```bash
bash tooling/scripts/install-knowledge-skills.sh
```

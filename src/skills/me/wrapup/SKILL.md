---
name: wrapup
description: End-of-session wrap-up — digest learnings, check git, capture next steps, compound solutions, stop dev servers. Use at the end of a session before signing off.
---

...
description: Critical thinking partnership with constructive disagreement. Use when the user wants to stress-test ideas, decisions, plans, or interpretations; receive honest, unfiltered critique; avoid confirmation bias; identify untested assumptions; or get direct pushback before acting. Triggers include "push back", "argue against this", "tell me what's wrong", "be honest", "challenge this", "devil's advocate", "stress-test this", "review this critically", "what am I missing", or any request for candid feedback.
---

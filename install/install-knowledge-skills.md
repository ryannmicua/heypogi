...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File install/scripts/install-knowledge-skills.ps1
```
...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File install/scripts/install-knowledge-skills.ps1 -CreateDest
```
...
```bash
bash install/scripts/install-knowledge-skills.sh
```

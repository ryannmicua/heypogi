...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File install/scripts/clone-opencode-source.ps1
```

To suppress prompts (e.g. for scripting):

```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File install/scripts/clone-opencode-source.ps1 -Quiet
```

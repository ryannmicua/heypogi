...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File install/scripts/install-skills.ps1
```
...
```powershell
powershell -NoProfile -ExecutionPolicy Bypass -File install/scripts/install-skills.ps1 -CreateDest
```
...
```bash
bash install/scripts/install-skills.sh
```
